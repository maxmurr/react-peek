...
import { initInspector } from "react-peek";

if (typeof window !== "undefined") {
	initInspector({
		endpoint: `http://127.0.0.1:${process.env.NEXT_PUBLIC_REACT_PEEK_PORT}/__react-peek/open`,
	});
}

const Header = () => (
	<header style={{ padding: "2rem", borderBottom: "1px solid #e5e7eb" }}>
		<h1 style={{ margin: 0, fontSize: "1.5rem" }}>react-peek Next.js demo</h1>
